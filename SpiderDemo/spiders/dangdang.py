...
from ..items import ScrapyredisproItem
...
class DangdangSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for div in div_list:
            ...
            print('11111111111111111111111111111111',item["b_cate"])
            item["b_cate"] = [i.strip() for i in item["b_cate"] if len(i.strip()) > 0]
            # 中间分类分组
            dl_list = div.xpath("./div//dl[@class='inner_dl']")
            print('222222222222222222222222222222222222',dl_list)
            for dl in dl_list:
                item["m_cate"] = dl.xpath("./dt//text()").extract()
                print('333333333333333333333333333333333333333', item["m_cate"])
